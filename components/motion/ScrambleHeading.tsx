 ...
 * span that the lazy ScrambleText plugin resolves. Desktop + motion-safe only;
 * reduced motion / no-JS keep the static text (and a screen reader always reads
 * the real sr-only copy, never the glyphs).
 */
